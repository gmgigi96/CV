...
\hardskill{Go, Python, MySQL, Git, Bash, Linux, Puppet, Container tecnologies (Docker), Distributed storage systems (EOS),
...
\begin{twenty}
	\twentyitem{2021-now}{Software Engineer}{CERN (Geneva)}{
	\begin{itemize}
	...
	\item Involved in the 3rd line of the CERNBox support
