...
\name{Gianmaria}{Del Monte}
\position{Software Engineer}
\address{Geneva - Switzerland}

\mobile{+41 078 225 24 27}
\email{gianmaria.del.monte@cern.ch}
% \dateofbirth{December 12th, 1996}
%\homepage{www.posquit0.com} 
\github{github.com/gmgigi96}
\linkedin{linkedin.com/in/gianmaria-del-monte-81575b162}
% \gitlab{gitlab-id}
